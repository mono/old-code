...
TRUNK=svn://svn.myrealbox.com/source/trunk
#TRUNK=svn+ssh://mono-cvs.ximian.com/source/trunk
...
svn checkout $TRUNK/mono $TRUNK/mcs || exit -1
...
# Fix up glib headers
grep -v 'define ftruncate' install/include/glib-2.0/glib/gwin32.h > tmp
mv tmp install/include/glib-2.0/glib/gwin32.h
