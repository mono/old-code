...
namespace GtkSharpTutorial {
	...
	public class radiobuttons
	{
		...
		public static void Main(string[] args)
		{
			...
			RadioButton radiobutton = new RadioButton  ("button1");
			box2.PackStart(radiobutton, true, true, 0);
			radiobutton.Show();
			RadioButton radiobutton2 = new RadioButton(radiobutton, "button2");
			radiobutton2.Active = true;
			box2.PackStart(radiobutton2, true, true, 0);
			radiobutton2.Show();
			
			RadioButton  radiobutton3 = new RadioButton(radiobutton, "button3");
